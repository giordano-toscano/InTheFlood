...
public class ObjectController : MonoBehaviour
{
    ...
    // across).
    private const float _minObjectDistance = 0.5f; //2.5f
    private const float _maxObjectDistance = 5.5f; //3.5f
    private const float _minObjectHeight = 0.5f;
    private const float _maxObjectHeight = 5.5f; // 3.5f
    ...
    public void Start()
    {
        _startingPosition = transform.localPosition; // original line: _startingPosition = transform.parent.localPosition;
